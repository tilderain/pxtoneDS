...
public :
	...
	void    Tone_Sample    ( bool b_mute_by_unit, int32_t ch_num, int32_t time_pan_index, int32_t smooth_smp, float freq, int _moo_fade_fade, int _moo_fade_count, int _moo_fade_max );
